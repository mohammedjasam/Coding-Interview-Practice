class myStack:
     ...
     def isEmpty(self):
         return self.size() == 0   # While there's nothing wrong with self.container == [],
                                   # there is a builtin function for that purpose, so we may as well use it.
                                   # And while we're at it, it's often nice to use your own internal functions,
